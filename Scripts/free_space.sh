...
delete "./Library/Application\ Support/Code/Crashpad/*"
delete "./Library/Application\ Support/Code/User/workspaceStorage/*"
delete "./Library/Application\ Support/Chrome/Default/*"
delete "./Library/Developer/CoreSimulator/*"
#delete "./Library/Application Support/Code/User/workspaceStorage/8cddb5f6846484f8d4043731207d3480/ms-vscode.cpptools/.browse.VC.db"
